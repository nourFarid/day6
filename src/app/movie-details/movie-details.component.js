...
function findMovies(id) {
        ...
        function (error, data) {
          ...
          var changeMovieCard = function () {
            ...
            related.forEach(function (movie) {
              relatedMoviesList += `<li><span onclick="findMovies(${
                movie.id
              })">${movie.title}</span> (${
  ...
  <div class="movie-details-container">
    <div class="column column-md"><img src="https://image.tmdb.org/t/p/w500${
      featureMovie.poster_path
    }" id="poster" />
    </div>
    <div class="column column-md">
      <h1 id="title">${featureMovie.title}<span id="date"> (${
              featureMovie.release_date.split("-")[0]
            })</span></h1>
<div class="row">
              <span class="badge"><span id="status">${
                featureMovie.status
              }</span>
              </span>
            </div>
